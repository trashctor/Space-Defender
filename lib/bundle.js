...
/***/ function(module, exports, __webpack_require__) {
			...
			switch (this.state.current) {
				case "MENU":
					return React.createElement(
						"div",
						{ id: "react-content-main" },
						React.createElement(
							"h1",
							{ id: "space-defenders-title" },
							"Space Defender"
						),
						React.createElement(
							"button",
							{ id: "start-game-button", onClick: this._handleNewGame },
							"Start Game"
						)
					);
				case "NEW_GAME":
					return React.createElement(
						...
						React.createElement(
							"div",
							{ id: "select-players", className: "group" },
							React.createElement(
								"button",
								{ id: "one-player-button", onClick: this._startGame.bind(this, false) },
								"One Player"
							),
							React.createElement(
								"button",
								{ id: "two-player-button", onClick: this._startGame.bind(this, true) },
								"Two Player"
							)
						)
					);
				...
				case "GAME_OVER":
					return React.createElement(
						...
						React.createElement(
							"button",
							{ id: "menu-button", onClick: this._handleMenu },
							"Menu"
						)
					);
				default:
	...
	$(function () {
		ReactDOM.render(React.createElement(SpaceDefender, null), $("#react-content-dom")[0]);
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var AABB = __webpack_require__(5);
	var BaseObject = __webpack_require__(7);
	var DynamicObject = __webpack_require__(8);
	var Util = __webpack_require__(6);
	var VectorHelper = __webpack_require__(9);
	var ColorHelper = __webpack_require__(10);
	
	var PlayerShip = __webpack_require__(12);
	var SpaceRock = __webpack_require__(19);
	var Particle = __webpack_require__(16);
	var EnemyShip = __webpack_require__(21);
	var EnemyTurret = __webpack_require__(25);
	var EnemyDestroyer = __webpack_require__(186);
	...
	Engine.prototype.renderBombs = function (ctx) {
		...
		var marginTop = this.height / 36;
		var marginLeftRight = this.width / 8;
		var player1 = this.playerObjects[1];
		var player2 = this.playerObjects[2];
...
/***/ function(module, exports) {
	...
	Vector.prototype.rotation = function (correction) {
		// correction is due to the what's considered up for the sprite image
		correction = correction || Math.PI / 2;
		return Math.atan2(this.y, this.x) + correction;
	};
	...
	BaseObject.prototype.draw = function (ctx) {
		...
		if (this.image) {
			if (this.collision.type === "AABB") {
				var AABBcenter = this.collision.getCenter();
	
				// stretch the image to the collision size and rotate it
				ctx.save();
				ctx.translate(AABBcenter.x, AABBcenter.y);
				...
				ctx.translate(this.collision.pos.x, this.collision.pos.y);
				ctx.rotate(this.rotation);
				ctx.translate(-this.collision.radius - this.collision.pos.x, -this.collision.radius - this.collision.pos.y);
			...
			ctx.beginPath();
			ctx.arc(this.collision.pos.x, this.collision.pos.y, this.collision.radius, 0, 2 * Math.PI, false);
			ctx.fill();
		} else {
	...
	var Color = function (colorString) {
		...
		if (colorString) {
			if (colorString.search("#") !== -1) {
				...
				this.trans = parseFloat(elementArr[3], 10);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var PlayerShot = __webpack_require__(13);
	var PlayerMissile = __webpack_require__(14);
	var PlayerMicroMissile = __webpack_require__(17);
	var PlayerBomb = __webpack_require__(18);
	
	var ParticleHelper = __webpack_require__(15);
...
/***/ function(module, exports, __webpack_require__) {
	...
	Particle.prototype.update = function () {
		...
		// help prevent heavy lag with too many particles
		if (currIter >= this.lastUpdateIter + this.updateCooldown) {
			this.lastUpdateIter = currIter;
			this.handleLifetime();
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var HpPowerup = __webpack_require__(20);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Util = __webpack_require__(6);
	var VectorHelper = __webpack_require__(9);
	var EnemyHelper = __webpack_require__(22);
	...
	var ParticleHelper = __webpack_require__(15);
	var EnemyShipShot = __webpack_require__(23);
	
	var HpPowerup = __webpack_require__(20);
	var BombPowerup = __webpack_require__(185);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ParticleHelper = __webpack_require__(15);
	var EnemyTurretShot = __webpack_require__(26);
	
	var HpPowerup = __webpack_require__(20);
	var SuperPowerup = __webpack_require__(24);
	var BombPowerup = __webpack_require__(185);
	...
	EnemyTurret.prototype.handlePowerups = function () {
		// chance to spawn powerup
		var chanceSpawnHp = 0.45;
		var chanceSpawnBomb = 0.3;
		var chanceSpawnSuper = 0.15;
		var id = SpaceDefender.game.engine.getUniqueId();
		var pos = this.collision.getCenter();
		var powerup;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ParticleHelper = __webpack_require__(15);
	var EnemyTurretShot = __webpack_require__(26);
	var EnemyMissile = __webpack_require__(187);
